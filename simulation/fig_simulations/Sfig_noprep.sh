...
do
    ...
    do  
        # NO PREP MOVEMENTS
        export sim_set=uni_noprep_rad
        export repertoire_pre=uni_
        export file=${repertoire_pre}10.0_noprep_rad
        ...
        do
            ...
            #PERTURBATION: ROT
            python3 simulation/run_pipeline.py perturbation $seed ${sim_set} ${repertoire_pre}${repertoire} -p rotation -pp 10.0 -n 1 -gpu 0 -o SGD -lr 0.005 -file ${file} 
        done

        export sim_set=uni_noprep_onehot
        export repertoire_pre=uni_
        export file=${repertoire_pre}10.0_noprep_onehot
